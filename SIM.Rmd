...
```{r Koneksi Data}
con <- DBI::dbConnect(odbc::odbc(), Driver = "MySQL ODBC 8.0 ANSI Driver", 
    Server = "127.0.0.1", Database = "classicmodels", UID = "root", 
    PWD = "tata230207", Port = 3306)
```
...
```{r visualisasi-piechart, fig.width=8, fig.height=5}
# Hitung persentase
